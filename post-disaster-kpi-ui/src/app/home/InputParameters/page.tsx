// src/app/home/InputParameters/page.tsx
...
// Define interfaces (you can move these to a separate file if preferred)
    ...
    <Box sx={{ padding: 4 }}>
      ...
      <Paper sx={{ padding: 4 }}>
        ...
        <InventoryPoliciesSection
          ...
          camps={camps}
          items={items}
          campBuffer={simulationConfig.campBuffer}
          centralBuffer={simulationConfig.centralBuffer}
          inventoryControlPeriod={simulationConfig.inventoryControlPeriod}
        />
